    ...
    <header className="sticky top-0 z-10 flex h-16 items-center justify-between border-b border-gray-200 bg-white px-4 dark:border-gray-700 dark:bg-gray-800 no-print">
      ...
      <div className="flex items-center gap-2">
        ...
        <div ref={notifRef} className="relative">
          ...
          {notifOpen && (
            <div className="absolute right-0 top-11 z-50 w-96 rounded-xl border border-gray-100 bg-white shadow-xl dark:border-gray-700 dark:bg-gray-800">
              {/* Header */}
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="mt-1 flex items-center gap-2">
                          <p className="text-xs text-gray-400 dark:text-gray-500">{timeAgo(n.created_at)}</p>
                          {link && (
                ...
                {isAdmin && (
                  <div className="flex flex-wrap gap-1">
                    <p className="w-full text-[10px] text-gray-400 mb-0.5 flex items-center gap-1">
                      <Zap className="h-3 w-3" /> Test notifications:
                    </p>
